...
a token is used when data is locked behind a login it tells us if we can send the user to the PrivateRoute

- [x] What steps can you take in your web apps to keep your data secure?

Make it that it can not be edited locally on the computer and have login dictated severside

- [x] Describe how web servers work.

web severs are computers that host websites and keep runing useing a company or other server warehouse
